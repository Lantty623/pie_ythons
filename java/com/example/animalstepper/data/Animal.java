...
public class Animal {
    ...
    //We agree to use the average 5 6" stride length = 27
    ...
    public static final String[] ANIMAL_LIST = {"Cat", "Elephant", "Horse", "Large Dog", "Medium Dog", "Small Dog", "Kangaroo"};
    ...
    public static double human_to_cat(long human, String unit) {
        double cat_step = 0;
        double len = 0;
        ...
        /*
            ...
            System.out.println("\n\n\nGive me an inches/cm. Not " + unit + "\n\n\n");
        }
         */
        return (int)(Math.round(cat_step));
    }

    public static double human_to_elephant(long human, String unit) {
        double ele_step = 0;
        double len = 0;
        if (unit.equals("inches")) {
            double length = (human * STRIDE_INCHES);
    ...
    //int human = the number of step
    public static double human_to_horse(long human, String unit) {
        double h_step = 0;
        double len = 0;
        if (unit.equals("inches")) {
    ...
    //int human = the number of step
    public static double human_to_ldog(long human, String unit) {
        double d_step = 0;
        double len = 0;
        if (unit.equals("inches")) {
            double length = (human * STRIDE_INCHES);
    ...
    public static double human_to_mdog(long human, String unit) {
        double d_step = 0;
        double len = 0;
        if (unit.equals("inches")) {
            double length = (human * STRIDE_INCHES);
    ...
    public static double human_to_sdog(long human, String unit) {
        double d_step = 0;
        double len = 0;
        if (unit.equals("inches")) {
            double length = (human * STRIDE_INCHES);
    ...
    public static double human_to_kangaroo(long human, String unit) {
        double k_step = 0;
        double len = 0;
        if (unit.equals("inches")) {
            double length = (human * STRIDE_INCHES);
